...
<body>
    ...
    <section id="menu" class="text-center">
        <div class="container">
            <h2>Checkout Our tasty <span>Appetizer</span></h2>           
        </div>
    </section>
       ...
       <tbody>
        <%
            ...
            try {
    			...
    			String query = "select * from menu where category='Appetizer'";
    			...
    			while(rs.next())
    			{
    				...
    				<td style="padding:20px;"><h1 id="food-title"><%=title %>
    				
    				</h1><p id="food-para"><%=description %></p><br>
    				
    				<p id="food-price">Price : <%=price %></p>
    				
    				<select id="spiceLevelSelect" class="spice-level" name="spice-level">
